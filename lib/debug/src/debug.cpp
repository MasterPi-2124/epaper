...
void enterDebugMode(UBYTE * BlackImage)
{
    ...
    Paint_DrawRectangle(80, 10, 130, 60, BLACK, DOT_PIXEL_2X2, DRAW_FILL_FULL);
    Paint_DrawRectangle(20, 10, 70, 60, BLACK, DOT_PIXEL_1X1, DRAW_FILL_EMPTY);

    Paint_DrawCircle(160, 20, 10, BLACK, DOT_PIXEL_1X1, DRAW_FILL_EMPTY);
    Paint_DrawCircle(190, 20, 10, BLACK, DOT_PIXEL_1X1, DRAW_FILL_FULL);

    Paint_DrawLine(150, 70, 170, 120, BLACK, DOT_PIXEL_1X1, LINE_STYLE_SOLID);
    Paint_DrawLine(170, 70, 190, 120, BLACK, DOT_PIXEL_2X2, LINE_STYLE_DOTTED);
    Paint_DrawLine(190, 70, 210, 120, BLACK, DOT_PIXEL_3X3, LINE_STYLE_SOLID);
