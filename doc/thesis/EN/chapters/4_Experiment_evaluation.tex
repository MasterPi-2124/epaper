...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{doc/imgs/mockup1.png}
    \caption{Mockup display of authentication page}
    \label{fig:Mockup1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{doc/imgs/mockup2.png}
    \caption{Mockup display of dashboard page}
    \label{fig:Mockup2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{doc/imgs/mockup3.png}
    \caption{Mockup display of modal component}
    \label{fig:Mockup3}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{doc/imgs/mockup4.png}
...
\begin{figure}[H]
    \centering
        ...
        \begin{umlseqdiag}
            ...
            \umlboundary[no ddots, scale = 1.6, x = 2.5]{AccountView}
            \umlcontrol[no ddots, scale = 1.6, x = 5]{UserController}
            \umlcontrol[no ddots, scale = 1.6, x = 10]{UserService}
            \umlentity[no ddots, scale = 1.6, x = 13]{UserModel}
            ...
            \begin{umlcall}[op={HandleSubmit(): void}, dt = 5]{Manager/ Administrator}{AccountView}
                ...
                \begin{umlfragment}[type=alt, label={user is null}, inner xsep = 15]
                    ...
                    \begin{umlcall}[op={success},  type=return, dt = 5]{AccountView}{Manager/ Administrator}
                    \end{umlcall}

                    \umlfpart[user existed]
                    \begin{umlcall}[op={email has been used},  type=return, dt=11]{UserController}{AccountView}
                    \end{umlcall}
...
\begin{table}[H]
    ...
    \begin{tabular}{| m{4cm} | m{4cm} | m{6cm} |}
        \hline
                            & \textbf{Back-end Server (web-server)} & \textbf{MQTT Broker (laboratory)} \\ \hline
