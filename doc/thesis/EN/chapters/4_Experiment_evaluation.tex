...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Input details of "Register new device" process}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Testing results of "Register new device" process}
    \label{fig:test_new-device-result}
\end{table}

\subsubsection{"Removing device" function testing}

The testing cases and results of the "Removing device" function are described in the table \ref{fig:test_remove-device-result} below.
\begin{table}[H]
    \newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
    \newcolumntype{L}[1]{>{\raggedright\arraybackslash}p{#1}}
    \renewcommand{\arraystretch}{3} % Adjust for row height
...
The testing cases and results of the "Removing data" function are described in the table \ref{fig:test_remove-data-result} below.
\begin{table}[H]
    \newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
    \newcolumntype{L}[1]{>{\raggedright\arraybackslash}p{#1}}
    \renewcommand{\arraystretch}{3} % Adjust for row height
    ...
    \end{tabular}
    \caption{Testing results of "Removing data" process}
    \label{fig:test_remove-data-result}
\end{table}
