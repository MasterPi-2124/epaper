...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        & 5.1a  & System        & If there is no active devices, notify users and finish the use case \\ \cline{2-4}
        & 7.1a	& System	    & Error: Can't write data to th device \\ \cline{2-4}
    \end{longtable}
}
...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        & 3     & Manager   & Fill in the user information (described below *) \\ \cline{2-4}
...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        & 5     & System    & Notify successful log-in, and rederiect to dashboard page \\ \hline
