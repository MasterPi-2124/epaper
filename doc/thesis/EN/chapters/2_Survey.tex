...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        \textbf{Actor}          & \multicolumn{3}{l|}{Manager, System, \gls{EPD} device} \\ \hline
        ...
        & 8.2	& System	            & Transmit data to the \gls{EPD} device \\ \cline{2-4}
        & 8.2.1	& Connected \gls{EPD} device  & Process the received information \\ \cline{2-4}
        & 8.2.2	& Connected \gls{EPD} device  & Connect to the Internet and MQTT Broker \\ \cline{2-4}
        & 8.2.3	& Connected \gls{EPD} device	& Send status information to the server \\ \cline{2-4}
...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        & 7.1   & System                & If the device is connected via USB, transmit data to the connected \gls{EPD} device \\ \cline{2-4}
        ...
        & 8     & Connected \gls{EPD} device  & Process the received information \\ \cline{2-4}
        & 8.1   & Connected \gls{EPD} device  & If the device is connected via USB, connect to the Internet and MQTT Broker \\ \cline{2-4}
        & 9     & Connected \gls{EPD} device  & Send status information to the server \\ \cline{2-4}
...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        & 6.2.1 & \gls{EPD} Device    & Process the received information, delete the displaying data information \\ \cline{2-4}
...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        & 7.1   & System        & If the user chooses to display data, transmit data to the connected \gls{EPD} device \\ \cline{2-4}
        & 7.2   & \gls{EPD} Device    & Process the received information \\ \cline{2-4}
        & 7.3   & \gls{EPD} Device    & Display the data \\ \cline{2-4}
        & 7.4   & \gls{EPD} Device    & Send status information to the server \\ \cline{2-4}
...
{\fontsize{9pt}{8pt}\selectfont 
    ...
    \begin{longtable}{|L{2cm}|L{1cm}|L{2cm}|L{7cm}|}
        ...
        & 6.2   & \gls{EPD} Device    & Process the received information, delete the displaying data information \\ \cline{2-4}
