...
\begin{figure}
\centering
\includegraphics[width=0.75\linewidth]{imgs/IoT.png}
...
Phần bìa trước chế bản theo qui định; bìa trước và bìa sau là giấy liền khổ. Sử dụng keo nhiệt để dán gáy khi đóng quyển thay vì sử dụng băng dính và dập ghim như mô tả ở imgs~\ref{fig:Bia}
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{imgs/Bia.PNG}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{imgs/GayBia.PNG}
\caption{Qui cách đóng quyển đồ án}
\label{fig:Bia}
\end{figure} 
